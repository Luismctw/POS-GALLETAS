...
self.addEventListener('fetch', e => {
  ...
  // API: siempre red; si falla, respuesta clara (no rompe la app)
  ...
  // Si no hay internet, se muestra "Reconectando…" (nunca una pantalla en blanco).
  e.respondWith(
    fetch(req).catch(() => {
